...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h2 class="head-home-page mt-5">جميع المتاجر</h2>
        </div>

        <div class="about-us mt-5 mb-5">
            <p>في هذا الموقع أحببنا أن نساعدكم في ترتيب أفكاركم لتقدمون ما تشعرون به لأحبائكم دون اشتراط للاشتراط أو دفع أي
                مبلغ للموقع نسعى أن نكون جزء من خدمتكم </p>
        </div>
